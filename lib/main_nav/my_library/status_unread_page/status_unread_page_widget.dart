...
import 'status_unread_page_model.dart';
export 'status_unread_page_model.dart';

class StatusUnreadPageWidget extends StatefulWidget {
  const StatusUnreadPageWidget({super.key});

  static String routeName = 'StatusUnreadPage';
  static String routePath = '/StatusUnreadPage';

  @override
  State<StatusUnreadPageWidget> createState() => _StatusUnreadPageWidgetState();
}

class _StatusUnreadPageWidgetState extends State<StatusUnreadPageWidget> {
  late StatusUnreadPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StatusUnreadPageModel());
