                  ...
                  builder: (context) {
                    return SafeArea(
                      ...
                      child: Container(
                        ...
                        child: FutureBuilder<List<AppLibraryCountsRow>>(
                          future: FFAppState()
                              .itemCount(
                          ...
                          builder: (context, snapshot) {
                            ...
                            final rootColumnAppLibraryCountsRow =
                                rootColumnAppLibraryCountsRowList.isNotEmpty
                                    ? rootColumnAppLibraryCountsRowList.first
                                    : null;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    StickyHeader(
                                      ...
                                      header: Visibility(
                                        visible: rootColumnAppLibraryCountsRow!
                                                .ownedCount! >
                                            0,
                                        child: Padding(
                                          padding:
                                                            ...
                                                            itemBuilder: (context,
                                                              ...
                                                              return FutureBuilder<
                                                                ...
                                                                builder: (context,
                                                                  ...
                                                                  final gridItemTitleUserTitleStatusRow = gridItemTitleUserTitleStatusRowList
                                                                          .isNotEmpty
                                                                      ? gridItemTitleUserTitleStatusRowList
                                                                          .first
                                                                      : null;
                                                                  ...
                                                                  return InkWell(
                                                                    ...
                                                                    onTap:
                                                                        () async {
                                                                      if ((gridVarItem.singleIssueId != null &&
                                                                              gridVarItem.singleIssueId !=
                                                                                  '') &&
                                                                          (gridVarItem.ownedCount ==
                                                                              1)) {
                                                                        context
                                                                            .pushNamed(
                                                                        ...
                                                                        if ((gridVarItem.firstStatusIssueId != null && gridVarItem.firstStatusIssueId != '') &&
                                                                            (gridVarItem.ownedCount ==
                                                                                1)) {
                                                                          context
                                                                              .pushNamed(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        issuePages:
                                                                            0,
                                                                        titleName:
                                                                            gridVarItem.titleName,
                                                                        titleSubtitle:
                                                                            gridVarItem.titleSubtitle,
                                                                        publisherName:
                                                                            gridVarItem.publisherName,
                                                                        licensors:
                                                                            gridVarItem.licensors,
                                                                        entityType:
                                                                            'title',
                                                                        entityId:
                                                                            gridVarItem.titleId,
                                                                        series:
                                                                            gridVarItem.series,
                                                                        publicationStatus:
                                                                            gridVarItem.publicationStatus,
                                                                        issueCount:
                                                                            gridVarItem.ownedCount,
                                                                        isSingleIssue:
                                                                            (gridVarItem.singleIssueId != null && gridVarItem.singleIssueId != '') &&
                                                                        ...
                                                                        indexPosition:
                                                                            null,
                                                                        thumb: gridVarItem.ownedT1 != null &&
                                                                                gridVarItem.ownedT1 != ''
                                                                            ? 'https://dlxinhmwtgrsqhwhmepg.supabase.co/storage/v1/object/public/${gridVarItem.ownedT1}'
                                                                            : null,
                                                                        thumb2: gridVarItem.ownedT2 != null &&
                                                                                gridVarItem.ownedT2 != ''
                                                                            ? 'https://dlxinhmwtgrsqhwhmepg.supabase.co/storage/v1/object/public/${gridVarItem.ownedT2}'
                                                                            : null,
                                                                        thumb3: gridVarItem.ownedT3 != null &&
                                                                                gridVarItem.ownedT3 != ''
                                                                            ? 'https://dlxinhmwtgrsqhwhmepg.supabase.co/storage/v1/object/public/${gridVarItem.ownedT3}'
                                                                            : null,
                                                                        isAdult:
                                                                            gridVarItem.isAdult,
                                                                        canSeelAdult: functions.canSeeAdultContent(
                                    ...
                                    if (currentUserUid == '')
                                      Expanded(
                                        child: Align(
                                          ...
                                          child: wrapWithModel(
                                            model:
                                                _model.userAreaEmptyStateModel,
                                            updateCallback: () =>
                                                safeSetState(() {}),
