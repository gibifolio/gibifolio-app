                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        if (widget.isBulk) {
                                          ...
                                          _model.selectedOwnership = 'wanted';
                                          safeSetState(() {});
                                        } else {
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        if (widget.isBulk) {
                                          ...
                                          _model.selectedOwnership = 'owned';
                                          safeSetState(() {});
                                        } else {
                                          if (widget.entityType == 'title') {
                                            if (_model.selectedOwnership ==
                                    ...
                                    child: FFButtonWidget(
                                      onPressed: () async {
                                        if (widget.isBulk) {
                                          ...
                                          _model.selectedReading = 'reading';
                                          safeSetState(() {});
                                        } else {
                                          if (widget.entityType == 'title') {
                                            ...
                                            if (_model.selectedReading ==
                                                'reading') {
                                              await actions.updateReadingStatus(
                                                widget.issueId!,
                                                widget.titleId!,
                                                '',
                                              );
                        ...
                        child: AnimatedContainer(
                          ...
                          child: FutureBuilder<List<AppUserCustomListsRow>>(
                            future: (_model.requestCompleter ??=
                                    Completer<List<AppUserCustomListsRow>>()
                                      ..complete(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return ListView.builder(
                                ...
                                itemCount:
                                    listViewAppUserCustomListsRowList.length,
