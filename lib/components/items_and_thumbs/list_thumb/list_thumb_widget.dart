...
import 'list_thumb_model.dart';
export 'list_thumb_model.dart';

class ListThumbWidget extends StatefulWidget {
  const ListThumbWidget({
    super.key,
    this.listTitle,
  ...
  @override
  State<ListThumbWidget> createState() => _ListThumbWidgetState();
}

class _ListThumbWidgetState extends State<ListThumbWidget> {
  late ListThumbModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListThumbModel());
