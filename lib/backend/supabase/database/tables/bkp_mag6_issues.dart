...
class BkpMag6IssuesTable extends SupabaseTable<BkpMag6IssuesRow> {
  @override
  String get tableName => 'bkp_mag6_issues';

  @override
  BkpMag6IssuesRow createRow(Map<String, dynamic> data) =>
      BkpMag6IssuesRow(data);
}

class BkpMag6IssuesRow extends SupabaseDataRow {
  BkpMag6IssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpMag6IssuesTable();
