...
class OrphanIssuesTable extends SupabaseTable<OrphanIssuesRow> {
  @override
  String get tableName => 'orphan_issues';

  @override
  OrphanIssuesRow createRow(Map<String, dynamic> data) => OrphanIssuesRow(data);
}

class OrphanIssuesRow extends SupabaseDataRow {
  OrphanIssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => OrphanIssuesTable();
