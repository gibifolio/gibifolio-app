...
class BkpXmenVariantTable extends SupabaseTable<BkpXmenVariantRow> {
  @override
  String get tableName => '_bkp_xmen_variant';

  @override
  BkpXmenVariantRow createRow(Map<String, dynamic> data) =>
      BkpXmenVariantRow(data);
}

class BkpXmenVariantRow extends SupabaseDataRow {
  BkpXmenVariantRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpXmenVariantTable();
