...
class BkpBrasinhaIssuesTable extends SupabaseTable<BkpBrasinhaIssuesRow> {
  @override
  String get tableName => 'bkp_brasinha_issues';

  @override
  BkpBrasinhaIssuesRow createRow(Map<String, dynamic> data) =>
      BkpBrasinhaIssuesRow(data);
}

class BkpBrasinhaIssuesRow extends SupabaseDataRow {
  BkpBrasinhaIssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpBrasinhaIssuesTable();
