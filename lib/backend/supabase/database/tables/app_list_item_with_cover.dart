...
class AppListItemWithCoverTable extends SupabaseTable<AppListItemWithCoverRow> {
  @override
  String get tableName => 'app_list_item_with_cover';

  @override
  AppListItemWithCoverRow createRow(Map<String, dynamic> data) =>
      AppListItemWithCoverRow(data);
}

class AppListItemWithCoverRow extends SupabaseDataRow {
  AppListItemWithCoverRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppListItemWithCoverTable();
