...
class AppTitleDetailTable extends SupabaseTable<AppTitleDetailRow> {
  @override
  String get tableName => 'app_title_detail';

  @override
  AppTitleDetailRow createRow(Map<String, dynamic> data) =>
      AppTitleDetailRow(data);
}

class AppTitleDetailRow extends SupabaseDataRow {
  AppTitleDetailRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppTitleDetailTable();
