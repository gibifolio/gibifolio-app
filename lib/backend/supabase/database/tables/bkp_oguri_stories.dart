...
class BkpOguriStoriesTable extends SupabaseTable<BkpOguriStoriesRow> {
  @override
  String get tableName => 'bkp_oguri_stories';

  @override
  BkpOguriStoriesRow createRow(Map<String, dynamic> data) =>
      BkpOguriStoriesRow(data);
}

class BkpOguriStoriesRow extends SupabaseDataRow {
  BkpOguriStoriesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpOguriStoriesTable();
