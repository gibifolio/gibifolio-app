...
class IssuesTable extends SupabaseTable<IssuesRow> {
  @override
  String get tableName => 'issues';

  @override
  IssuesRow createRow(Map<String, dynamic> data) => IssuesRow(data);
}

class IssuesRow extends SupabaseDataRow {
  IssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => IssuesTable();
