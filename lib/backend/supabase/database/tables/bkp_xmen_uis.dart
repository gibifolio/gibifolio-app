...
class BkpXmenUisTable extends SupabaseTable<BkpXmenUisRow> {
  @override
  String get tableName => '_bkp_xmen_uis';

  @override
  BkpXmenUisRow createRow(Map<String, dynamic> data) => BkpXmenUisRow(data);
}

class BkpXmenUisRow extends SupabaseDataRow {
  BkpXmenUisRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpXmenUisTable();
