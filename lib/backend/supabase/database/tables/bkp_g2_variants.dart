...
class BkpG2VariantsTable extends SupabaseTable<BkpG2VariantsRow> {
  @override
  String get tableName => 'bkp_g2_variants';

  @override
  BkpG2VariantsRow createRow(Map<String, dynamic> data) =>
      BkpG2VariantsRow(data);
}

class BkpG2VariantsRow extends SupabaseDataRow {
  BkpG2VariantsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG2VariantsTable();
