...
class BkpG2cVariantsTable extends SupabaseTable<BkpG2cVariantsRow> {
  @override
  String get tableName => 'bkp_g2c_variants';

  @override
  BkpG2cVariantsRow createRow(Map<String, dynamic> data) =>
      BkpG2cVariantsRow(data);
}

class BkpG2cVariantsRow extends SupabaseDataRow {
  BkpG2cVariantsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG2cVariantsTable();
