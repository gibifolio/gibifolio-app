...
class OrphanVariantsTable extends SupabaseTable<OrphanVariantsRow> {
  @override
  String get tableName => 'orphan_variants';

  @override
  OrphanVariantsRow createRow(Map<String, dynamic> data) =>
      OrphanVariantsRow(data);
}

class OrphanVariantsRow extends SupabaseDataRow {
  OrphanVariantsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => OrphanVariantsTable();
