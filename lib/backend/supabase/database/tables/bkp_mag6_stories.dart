...
class BkpMag6StoriesTable extends SupabaseTable<BkpMag6StoriesRow> {
  @override
  String get tableName => 'bkp_mag6_stories';

  @override
  BkpMag6StoriesRow createRow(Map<String, dynamic> data) =>
      BkpMag6StoriesRow(data);
}

class BkpMag6StoriesRow extends SupabaseDataRow {
  BkpMag6StoriesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpMag6StoriesTable();
