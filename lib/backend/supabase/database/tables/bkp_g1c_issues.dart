...
class BkpG1cIssuesTable extends SupabaseTable<BkpG1cIssuesRow> {
  @override
  String get tableName => 'bkp_g1c_issues';

  @override
  BkpG1cIssuesRow createRow(Map<String, dynamic> data) => BkpG1cIssuesRow(data);
}

class BkpG1cIssuesRow extends SupabaseDataRow {
  BkpG1cIssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG1cIssuesTable();
