...
class BkpG1cDeletedvarsTable extends SupabaseTable<BkpG1cDeletedvarsRow> {
  @override
  String get tableName => 'bkp_g1c_deletedvars';

  @override
  BkpG1cDeletedvarsRow createRow(Map<String, dynamic> data) =>
      BkpG1cDeletedvarsRow(data);
}

class BkpG1cDeletedvarsRow extends SupabaseDataRow {
  BkpG1cDeletedvarsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG1cDeletedvarsTable();
