...
class BkpDupVariants20260727Table
    extends SupabaseTable<BkpDupVariants20260727Row> {
  @override
  String get tableName => 'bkp_dup_variants_20260727';

  @override
  BkpDupVariants20260727Row createRow(Map<String, dynamic> data) =>
      BkpDupVariants20260727Row(data);
}

class BkpDupVariants20260727Row extends SupabaseDataRow {
  BkpDupVariants20260727Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpDupVariants20260727Table();
