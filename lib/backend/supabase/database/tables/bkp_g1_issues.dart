...
class BkpG1IssuesTable extends SupabaseTable<BkpG1IssuesRow> {
  @override
  String get tableName => 'bkp_g1_issues';

  @override
  BkpG1IssuesRow createRow(Map<String, dynamic> data) => BkpG1IssuesRow(data);
}

class BkpG1IssuesRow extends SupabaseDataRow {
  BkpG1IssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG1IssuesTable();
