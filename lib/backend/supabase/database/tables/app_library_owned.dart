...
class AppLibraryOwnedTable extends SupabaseTable<AppLibraryOwnedRow> {
  @override
  String get tableName => 'app_library_owned';

  @override
  AppLibraryOwnedRow createRow(Map<String, dynamic> data) =>
      AppLibraryOwnedRow(data);
}

class AppLibraryOwnedRow extends SupabaseDataRow {
  AppLibraryOwnedRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppLibraryOwnedTable();
  ...
  String? get ownedT1 => getField<String>('owned_t1');
  set ownedT1(String? value) => setField<String>('owned_t1', value);

  String? get ownedT2 => getField<String>('owned_t2');
  set ownedT2(String? value) => setField<String>('owned_t2', value);

  String? get ownedT3 => getField<String>('owned_t3');
  set ownedT3(String? value) => setField<String>('owned_t3', value);
