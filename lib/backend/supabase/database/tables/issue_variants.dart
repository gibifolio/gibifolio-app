...
class IssueVariantsTable extends SupabaseTable<IssueVariantsRow> {
  @override
  String get tableName => 'issue_variants';

  @override
  IssueVariantsRow createRow(Map<String, dynamic> data) =>
      IssueVariantsRow(data);
}

class IssueVariantsRow extends SupabaseDataRow {
  IssueVariantsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => IssueVariantsTable();
