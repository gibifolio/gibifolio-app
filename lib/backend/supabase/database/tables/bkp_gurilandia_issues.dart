...
class BkpGurilandiaIssuesTable extends SupabaseTable<BkpGurilandiaIssuesRow> {
  @override
  String get tableName => 'bkp_gurilandia_issues';

  @override
  BkpGurilandiaIssuesRow createRow(Map<String, dynamic> data) =>
      BkpGurilandiaIssuesRow(data);
}

class BkpGurilandiaIssuesRow extends SupabaseDataRow {
  BkpGurilandiaIssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpGurilandiaIssuesTable();
