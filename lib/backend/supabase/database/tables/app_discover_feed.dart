...
class AppDiscoverFeedTable extends SupabaseTable<AppDiscoverFeedRow> {
  @override
  String get tableName => 'app_discover_feed';

  @override
  AppDiscoverFeedRow createRow(Map<String, dynamic> data) =>
      AppDiscoverFeedRow(data);
}

class AppDiscoverFeedRow extends SupabaseDataRow {
  AppDiscoverFeedRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppDiscoverFeedTable();
