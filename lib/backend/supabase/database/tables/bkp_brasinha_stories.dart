...
class BkpBrasinhaStoriesTable extends SupabaseTable<BkpBrasinhaStoriesRow> {
  @override
  String get tableName => 'bkp_brasinha_stories';

  @override
  BkpBrasinhaStoriesRow createRow(Map<String, dynamic> data) =>
      BkpBrasinhaStoriesRow(data);
}

class BkpBrasinhaStoriesRow extends SupabaseDataRow {
  BkpBrasinhaStoriesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpBrasinhaStoriesTable();
