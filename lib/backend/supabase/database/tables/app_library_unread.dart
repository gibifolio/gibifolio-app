...
class AppLibraryUnreadTable extends SupabaseTable<AppLibraryUnreadRow> {
  @override
  String get tableName => 'app_library_unread';

  @override
  AppLibraryUnreadRow createRow(Map<String, dynamic> data) =>
      AppLibraryUnreadRow(data);
}

class AppLibraryUnreadRow extends SupabaseDataRow {
  AppLibraryUnreadRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppLibraryUnreadTable();
  ...
  String? get unreadT1 => getField<String>('unread_t1');
  set unreadT1(String? value) => setField<String>('unread_t1', value);

  String? get unreadT2 => getField<String>('unread_t2');
  set unreadT2(String? value) => setField<String>('unread_t2', value);

  String? get unreadT3 => getField<String>('unread_t3');
  set unreadT3(String? value) => setField<String>('unread_t3', value);
