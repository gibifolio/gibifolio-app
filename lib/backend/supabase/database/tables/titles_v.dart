...
class TitlesVTable extends SupabaseTable<TitlesVRow> {
  @override
  String get tableName => 'titles_v';

  @override
  TitlesVRow createRow(Map<String, dynamic> data) => TitlesVRow(data);
}

class TitlesVRow extends SupabaseDataRow {
  TitlesVRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => TitlesVTable();
  ...
  String? get licensorsNormalized => getField<String>('licensors_normalized');
  set licensorsNormalized(String? value) =>
      setField<String>('licensors_normalized', value);
}
