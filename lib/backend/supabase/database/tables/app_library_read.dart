...
class AppLibraryReadTable extends SupabaseTable<AppLibraryReadRow> {
  @override
  String get tableName => 'app_library_read';

  @override
  AppLibraryReadRow createRow(Map<String, dynamic> data) =>
      AppLibraryReadRow(data);
}

class AppLibraryReadRow extends SupabaseDataRow {
  AppLibraryReadRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppLibraryReadTable();
  ...
  String? get readT1 => getField<String>('read_t1');
  set readT1(String? value) => setField<String>('read_t1', value);

  String? get readT2 => getField<String>('read_t2');
  set readT2(String? value) => setField<String>('read_t2', value);

  String? get readT3 => getField<String>('read_t3');
  set readT3(String? value) => setField<String>('read_t3', value);
