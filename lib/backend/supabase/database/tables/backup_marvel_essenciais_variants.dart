...
class BackupMarvelEssenciaisVariantsTable
    extends SupabaseTable<BackupMarvelEssenciaisVariantsRow> {
  @override
  String get tableName => '_backup_marvel_essenciais_variants';

  @override
  BackupMarvelEssenciaisVariantsRow createRow(Map<String, dynamic> data) =>
      BackupMarvelEssenciaisVariantsRow(data);
}

class BackupMarvelEssenciaisVariantsRow extends SupabaseDataRow {
  BackupMarvelEssenciaisVariantsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BackupMarvelEssenciaisVariantsTable();
