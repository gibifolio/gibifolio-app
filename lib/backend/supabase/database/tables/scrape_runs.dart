...
class ScrapeRunsTable extends SupabaseTable<ScrapeRunsRow> {
  @override
  String get tableName => 'scrape_runs';

  @override
  ScrapeRunsRow createRow(Map<String, dynamic> data) => ScrapeRunsRow(data);
}

class ScrapeRunsRow extends SupabaseDataRow {
  ScrapeRunsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => ScrapeRunsTable();
