...
class AppReleasesAllTable extends SupabaseTable<AppReleasesAllRow> {
  @override
  String get tableName => 'app_releases_all';

  @override
  AppReleasesAllRow createRow(Map<String, dynamic> data) =>
      AppReleasesAllRow(data);
}

class AppReleasesAllRow extends SupabaseDataRow {
  AppReleasesAllRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppReleasesAllTable();
  ...
  bool? get isUpcoming => getField<bool>('is_upcoming');
  set isUpcoming(bool? value) => setField<bool>('is_upcoming', value);
}
