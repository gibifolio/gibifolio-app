...
class BkpAcompVariantsTable extends SupabaseTable<BkpAcompVariantsRow> {
  @override
  String get tableName => 'bkp_acomp_variants';

  @override
  BkpAcompVariantsRow createRow(Map<String, dynamic> data) =>
      BkpAcompVariantsRow(data);
}

class BkpAcompVariantsRow extends SupabaseDataRow {
  BkpAcompVariantsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpAcompVariantsTable();
