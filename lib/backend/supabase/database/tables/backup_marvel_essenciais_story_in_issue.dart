...
class BackupMarvelEssenciaisStoryInIssueTable
    extends SupabaseTable<BackupMarvelEssenciaisStoryInIssueRow> {
  @override
  String get tableName => '_backup_marvel_essenciais_story_in_issue';

  @override
  BackupMarvelEssenciaisStoryInIssueRow createRow(Map<String, dynamic> data) =>
      BackupMarvelEssenciaisStoryInIssueRow(data);
}

class BackupMarvelEssenciaisStoryInIssueRow extends SupabaseDataRow {
  BackupMarvelEssenciaisStoryInIssueRow(Map<String, dynamic> data)
      : super(data);

  @override
  SupabaseTable get table => BackupMarvelEssenciaisStoryInIssueTable();
