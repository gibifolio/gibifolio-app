...
class BkpG1cStoriesTable extends SupabaseTable<BkpG1cStoriesRow> {
  @override
  String get tableName => 'bkp_g1c_stories';

  @override
  BkpG1cStoriesRow createRow(Map<String, dynamic> data) =>
      BkpG1cStoriesRow(data);
}

class BkpG1cStoriesRow extends SupabaseDataRow {
  BkpG1cStoriesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG1cStoriesTable();
