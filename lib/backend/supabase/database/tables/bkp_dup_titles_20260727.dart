...
class BkpDupTitles20260727Table extends SupabaseTable<BkpDupTitles20260727Row> {
  @override
  String get tableName => 'bkp_dup_titles_20260727';

  @override
  BkpDupTitles20260727Row createRow(Map<String, dynamic> data) =>
      BkpDupTitles20260727Row(data);
}

class BkpDupTitles20260727Row extends SupabaseDataRow {
  BkpDupTitles20260727Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpDupTitles20260727Table();
