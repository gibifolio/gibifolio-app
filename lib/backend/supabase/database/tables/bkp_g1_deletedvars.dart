...
class BkpG1DeletedvarsTable extends SupabaseTable<BkpG1DeletedvarsRow> {
  @override
  String get tableName => 'bkp_g1_deletedvars';

  @override
  BkpG1DeletedvarsRow createRow(Map<String, dynamic> data) =>
      BkpG1DeletedvarsRow(data);
}

class BkpG1DeletedvarsRow extends SupabaseDataRow {
  BkpG1DeletedvarsRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpG1DeletedvarsTable();
