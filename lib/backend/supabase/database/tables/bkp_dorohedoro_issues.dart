...
class BkpDorohedoroIssuesTable extends SupabaseTable<BkpDorohedoroIssuesRow> {
  @override
  String get tableName => 'bkp_dorohedoro_issues';

  @override
  BkpDorohedoroIssuesRow createRow(Map<String, dynamic> data) =>
      BkpDorohedoroIssuesRow(data);
}

class BkpDorohedoroIssuesRow extends SupabaseDataRow {
  BkpDorohedoroIssuesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpDorohedoroIssuesTable();
