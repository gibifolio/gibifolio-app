...
class EmptyTitlesTable extends SupabaseTable<EmptyTitlesRow> {
  @override
  String get tableName => 'empty_titles';

  @override
  EmptyTitlesRow createRow(Map<String, dynamic> data) => EmptyTitlesRow(data);
}

class EmptyTitlesRow extends SupabaseDataRow {
  EmptyTitlesRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => EmptyTitlesTable();
