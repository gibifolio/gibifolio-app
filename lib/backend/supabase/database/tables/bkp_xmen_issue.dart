...
class BkpXmenIssueTable extends SupabaseTable<BkpXmenIssueRow> {
  @override
  String get tableName => '_bkp_xmen_issue';

  @override
  BkpXmenIssueRow createRow(Map<String, dynamic> data) => BkpXmenIssueRow(data);
}

class BkpXmenIssueRow extends SupabaseDataRow {
  BkpXmenIssueRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => BkpXmenIssueTable();
