...
class AppLibraryStatusReadingTable
    extends SupabaseTable<AppLibraryStatusReadingRow> {
  @override
  String get tableName => 'app_library_status_reading';

  @override
  AppLibraryStatusReadingRow createRow(Map<String, dynamic> data) =>
      AppLibraryStatusReadingRow(data);
}

class AppLibraryStatusReadingRow extends SupabaseDataRow {
  AppLibraryStatusReadingRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => AppLibraryStatusReadingTable();
  ...
  String? get readingT1 => getField<String>('reading_t1');
  set readingT1(String? value) => setField<String>('reading_t1', value);

  String? get readingT2 => getField<String>('reading_t2');
  set readingT2(String? value) => setField<String>('reading_t2', value);

  String? get readingT3 => getField<String>('reading_t3');
  set readingT3(String? value) => setField<String>('reading_t3', value);
