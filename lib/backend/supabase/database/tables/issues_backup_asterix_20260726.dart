...
class IssuesBackupAsterix20260726Table
    extends SupabaseTable<IssuesBackupAsterix20260726Row> {
  @override
  String get tableName => 'issues_backup_asterix_20260726';

  @override
  IssuesBackupAsterix20260726Row createRow(Map<String, dynamic> data) =>
      IssuesBackupAsterix20260726Row(data);
}

class IssuesBackupAsterix20260726Row extends SupabaseDataRow {
  IssuesBackupAsterix20260726Row(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => IssuesBackupAsterix20260726Table();
