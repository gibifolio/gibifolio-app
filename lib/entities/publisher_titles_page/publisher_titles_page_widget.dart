...
import 'publisher_titles_page_model.dart';
export 'publisher_titles_page_model.dart';

class PublisherTitlesPageWidget extends StatefulWidget {
  const PublisherTitlesPageWidget({
    super.key,
    this.publisherId,
    this.publisherName,
  });
  ...
  static String routeName = 'PublisherTitlesPage';
  static String routePath = '/PublisherTitlesPage';

  @override
  State<PublisherTitlesPageWidget> createState() =>
      _PublisherTitlesPageWidgetState();
}

class _PublisherTitlesPageWidgetState extends State<PublisherTitlesPageWidget> {
  late PublisherTitlesPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PublisherTitlesPageModel());

    // On page load action.
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await actions.fetchPublisherTitles(
        widget.publisherId!,
        0,
      );
    });
                                    ...
                                    itemBuilder: (context, searchResultsIndex) {
                                      ...
                                      return wrapWithModel(
                                        ...
                                        child: ListItemWidget(
                                          key: Key(
                                            'Keynh6_${searchResultsItem.titleId}',
                                          ),
                                          issueId:
