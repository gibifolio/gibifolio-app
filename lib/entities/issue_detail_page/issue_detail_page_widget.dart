                                                                ...
                                                                children: [
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                        Visibility(
                                                                      visible:
                                                                          issueDetailPageAppIssueDetailRow!.variantCount! >
                                                                              1,
                                                                      child:
                                                                          Text(
                                                                        valueOrDefault<
                                                                            String>(
                                                                          '${() {
                                                                            if (carouselIssueVariantsRow.variantLabel ==
                                                                                'STD') {
                                                                              return '';
                                                                            } else if (carouselIssueVariantsRow.variantLabel != null &&
                                                                              ...
                                                                              "yMMM",
                                                                              carouselIssueVariantsRow.releaseDate,
                                                                  ...
                                                                  Row(
                                                                    mainAxisSize:
                                                                        MainAxisSize
                                                                            .max,
                                                                    children: [
                                                                      if ((issueDetailPageAppIssueDetailRow?.pages !=
                                                                              null) &&
                                                                          (issueDetailPageAppIssueDetailRow?.date !=
                                                                              null))
                                                                        Align(
                                                                          alignment: AlignmentDirectional(
                                                                              -1.0,
                                                            ...
                                                            return wrapWithModel(
                                                              ...
                                                              child:
                                                                ...
                                                                storyId:
                                                                    storiescreditsVarItem
                                                                        .storyId,
                                                                title: storiescreditsVarItem.storyTitle !=
                                                                            null &&
                                                                        storiescreditsVarItem.storyTitle !=
                                                                            ''
                                                                    ? storiescreditsVarItem
                                                                        .storyTitle
                                                                    : null,
                                                                number: storiescreditsVarItem
                                                                    .seqInIssue,
                                                                titleOriginal: storiescreditsVarItem.originalTitle !=
                                                                            null &&
                                                                        storiescreditsVarItem.originalTitle !=
                                                                            ''
                                                                    ? storiescreditsVarItem
                                                                        .originalTitle
                                                                    : null,
                                                                synopsis: storiescreditsVarItem.synopsis !=
                                                                            null &&
                                                                        storiescreditsVarItem.synopsis !=
                                                                            ''
                                                                    ? storiescreditsVarItem
                                                                        .synopsis
                                                                    : null,
                                      ...
                                      children: [
                                        if (FFAppState().isAdminUser)
                                          FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              _model.queueIssueResult =
                                                  await actions.queueReview(
                                                'issue',
                                                widget.issueId!,
                                                '',
                                              );
                                              if (_model.queueIssueResult ==
                                                  'success') {
